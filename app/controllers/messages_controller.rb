class MessagesController < ApplicationController
  ...
  def reply
    ...
    product = product_selector(message_body)
    response = product.to_s.capitalize
    boot_twilio
    sms = @client.messages.create(
      from: Rails.application.secrets.twilio_number,
      to: from_number,
      body: "Hello there, I think #{response} matches your need. Respond Yes to have it delivered to you in 2 days"
    )
  end
